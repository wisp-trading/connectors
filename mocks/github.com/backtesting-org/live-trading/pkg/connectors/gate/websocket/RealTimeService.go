...
import (
	websocket "github.com/backtesting-org/live-trading/pkg/connectors/gate/websocket"
...
// SubscribeToOrders provides a mock function with given fields: callback
func (_m *RealTimeService) SubscribeToOrders(callback func(*websocket.OrderMessage)) (int, error) {
	ret := _m.Called(callback)

	if len(ret) == 0 {
		panic("no return value specified for SubscribeToOrders")
	}

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(func(*websocket.OrderMessage)) (int, error)); ok {
		return rf(callback)
	}
	if rf, ok := ret.Get(0).(func(func(*websocket.OrderMessage)) int); ok {
		r0 = rf(callback)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(func(*websocket.OrderMessage)) error); ok {
		r1 = rf(callback)
	} else {
		r1 = ret.Error(1)
	}
...
// RealTimeService_SubscribeToOrders_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SubscribeToOrders'
type RealTimeService_SubscribeToOrders_Call struct {
	*mock.Call
}

// SubscribeToOrders is a helper method to define mock.On call
//   - callback func(*websocket.OrderMessage)
func (_e *RealTimeService_Expecter) SubscribeToOrders(callback interface{}) *RealTimeService_SubscribeToOrders_Call {
	return &RealTimeService_SubscribeToOrders_Call{Call: _e.mock.On("SubscribeToOrders", callback)}
}

func (_c *RealTimeService_SubscribeToOrders_Call) Run(run func(callback func(*websocket.OrderMessage))) *RealTimeService_SubscribeToOrders_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(*websocket.OrderMessage)))
	})
	return _c
}

func (_c *RealTimeService_SubscribeToOrders_Call) Return(_a0 int, _a1 error) *RealTimeService_SubscribeToOrders_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RealTimeService_SubscribeToOrders_Call) RunAndReturn(run func(func(*websocket.OrderMessage)) (int, error)) *RealTimeService_SubscribeToOrders_Call {
	_c.Call.Return(run)
	return _c
}
