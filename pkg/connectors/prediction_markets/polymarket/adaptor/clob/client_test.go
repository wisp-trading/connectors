...
//		Context("when given valid conf", func() {
//			It("should configure the client successfully", func() {
//				err := client.Configure(conf)
//				Expect(err).ToNot(HaveOccurred())
//				Expect(client.IsConfigured()).To(BeTrue())
//			})
//		})
//
//		Context("when given nil conf", func() {
//			It("should return an error", func() {
//				err := client.Configure(nil)
//				Expect(err).To(HaveOccurred())
//				Expect(err.Error()).To(ContainSubstring("conf cannot be nil"))
//			})
//		})
//
//		Context("when given invalid conf", func() {
